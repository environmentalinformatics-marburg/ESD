...
## MODIS preprocessing
fls_ppc <- list.files("/media/permanent/programming/r/MODIS/data/MCD13A1.006/whittaker/", 
...
## GIMMS preprocessing
fls_ppc <- list.files("/media/permanent/programming/r/MODIS/data/NDVI3g.v1", 
                      pattern = "yL5000.*.tif$", full.names = TRUE)
fls_ppc <- fls_ppc[sapply(c("2015001", "2015015"), function(i) grep(i, fls_ppc))]
